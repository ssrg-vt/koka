...
extractDef updateVis def@(Core.Def name tp expr vis seca attr sort inl nameRng doc)
...
coreDefInfo def@(Core.Def name tp expr vis seca attr sort inl nameRng doc)
