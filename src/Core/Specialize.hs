  ...
  = do
      ...
      let specBody0
            = (\body -> case mybeTypeArgs of
              ...
              $ Let [DefNonRec $ Def param typ arg Private Nothing Nothing DefVal InlineAuto rangeNull "" -- bind specialized parameters
      ...
      let specDef = Def specName specType sspecBody Private Nothing Nothing sort InlineAuto rangeNull
